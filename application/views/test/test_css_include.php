...
<!--     <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/stylesheets/theme.css"> -->
<!--     <link rel="stylesheet" href="<?= base_url(); ?>assets/lib/font-awesome/css/font-awesome.css"> -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/stylesheets/theme.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/lib/font-awesome/css/font-awesome.css">
    
    <script src="<?= base_url(); ?>assets/lib/jquery-1.7.2.min.js" type="text/javascript"></script>
...
<div class="row-fluid">
    ...
    <script src="<?= base_url(); ?>assets/lib/lib/bootstrap/js/bootstrap.js"></script>
