...
<aside class="left-side sidebar-offcanvas .pre-scrollable" >
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<!-- 				<ul class="treeview-menu"> -->
			<!-- 					<li><a href="top"> -->
			<!-- 							<i class="fa fa-angle-double-right"></i>Top -->
			<!-- 						</a> -->
			<!-- 					</li> -->
			<!-- 					<li><a href="profile"> -->
			<!-- 							<i class="fa fa-angle-double-right"></i>Client -->
			<!-- 						</a> -->
			<!-- 					</li> -->
			<!-- 					<li><a href="client_list"> -->
			<!-- 							<i class="fa fa-angle-double-right"></i>Client List -->
			<!-- 						</a></li> -->
			<!-- 					<li><a href="client_detail"> -->
			<!-- 							<i class="fa fa-angle-double-right"></i>Client Detail -->
			<!-- 						</a></li> -->
